...
export default function Passwordreset({auth,email}) {
  ...
  const credential = EmailAuthProvider.credential(email,oldPassword);// to authenticate that password is correct for given email
        ...
        <CardContent className=" space-y-4 pt-5 ">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input id="password" onChange={((e)=>{setOldPassword(e.target.value)})} type={showOldPassword ? "text" : "password"} value={oldPassword} required />
              <Button
                variant="ghost"
                size="icon"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input id="password" onChange={((e)=>{setNewPassword(e.target.value)})} type={showPassword ? "text" : "password"} value={newPassword} required />
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-1/2 right-3 -translate-y-1/2"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input id="confirmPassword" value={confirmPassword} onChange={((e)=>{setConfirmPassword(e.target.value)})} type={showPasswordConfirm ? "text" : "password"} required />
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-1/2 right-3 -translate-y-1/2 "
